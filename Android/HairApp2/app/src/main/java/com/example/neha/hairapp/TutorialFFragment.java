...
public class TutorialFFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //saveInformation();
                HairAppCode.favfrag=new FavoritesFragment();
                FragmentManager fragmentManager4 = getFragmentManager();
                FragmentTransaction fragmentTransaction4 = fragmentManager4.beginTransaction();
                fragmentTransaction4.remove(TutorialFFragment.this);
                fragmentTransaction4.replace(R.id.fragment_id, HairAppCode.favfrag);
                fragmentTransaction4.addToBackStack("");
